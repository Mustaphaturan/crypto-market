...
export class ApiService {
  ...
  getCurreny(currency:string) {
    return this.http.get<any>(`https://api.coingecko.com/api/v3/coins/markets?vs_currency=${currency}&border=market_cap_desc&sparkline=false`);
